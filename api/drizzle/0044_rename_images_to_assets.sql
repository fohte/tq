...
UPDATE "task_pages" SET "content" = replace("content", '](/api/images/', '](/api/assets/') WHERE "content" LIKE '%](/api/images/%';--> statement-breakpoint
UPDATE "projects" SET "description" = replace("description", '](/api/images/', '](/api/assets/') WHERE "description" LIKE '%](/api/images/%';--> statement-breakpoint
UPDATE "recurring_task_templates" SET "description" = replace("description", '](/api/images/', '](/api/assets/') WHERE "description" LIKE '%](/api/images/%';

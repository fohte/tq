...
// Classifies an id-like string (a `#123` mention, a `/tasks/<id-or-number>`
// URL segment, a route param, ...) as either a Postgres-safe integer or an
// opaque id such as a UUID.

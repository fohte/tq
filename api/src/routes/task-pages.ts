...
const pageFormatSchema = z
  ...
  .describe(
    'Content format of this page. "markdown" (default) renders as ' +
      ...
      'cookies, localStorage, or API (no same-origin access), so it must ' +
      'be a self-contained document with any CSS/JS inlined — do not ' +
      'reference external stylesheets or scripts.',
  )

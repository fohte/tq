...
export function registerProjectCommands(
  ...
  unwrap(
    ...
    async (
      ...
      const query: ListProjectsQuery = unwrap(
        pickSchemaFields(listProjectsQuerySchema, options),
      )
  ...
  unwrap(
    ...
    async (
      ...
      const json: CreateProjectJson = {
        ...unwrap(pickSchemaFields(createProjectSchema, options, ['title'])),
        title,
      }
  ...
  unwrap(
    ...
    async (id: string, options: Record<string, unknown>, command: Command) => {
      const client = unwrap(buildClient(command, fetchImpl))
      const json: UpdateProjectJson = unwrap(
        pickSchemaFields(updateProjectSchema, options),
      )

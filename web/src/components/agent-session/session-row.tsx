...
function EditableSessionLabel({
  ...
  return (
    <Button
      ...
      className={cn(
        'h-auto min-h-0 flex-1 justify-start gap-0 rounded-none border-0 bg-transparent p-0 font-normal shadow-none transition-none hover:bg-transparent active:translate-y-0 truncate text-left font-mono text-xs',

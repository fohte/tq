    ...
    <SidebarField label="ESTIMATE">
      {isEditing ? (
        ...
        <Button
          ...
          className="h-auto min-h-0 shrink justify-start whitespace-normal gap-0 rounded-none border-0 bg-transparent p-0 font-normal shadow-none transition-none hover:bg-transparent active:translate-y-0 w-full cursor-text text-left transition-colors hover:text-muted-foreground-strong"
        >
          {estimatedMinutes != null ? formatMinutes(estimatedMinutes) : '—'}
        </Button>
      )}

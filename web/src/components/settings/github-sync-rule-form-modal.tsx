      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="flex flex-col gap-3">
          ...
          <FieldRow label="反映先プロジェクト">
            ...
            >
              <SelectTrigger
                iconClassName="size-3 text-foreground stroke-[2.5]"
                className="h-auto data-[size=default]:h-auto w-full gap-0.5 border-0 bg-transparent dark:bg-transparent hover:bg-transparent dark:hover:bg-transparent p-0 pr-0.5 pl-1 py-px text-sm text-foreground shadow-none outline-none focus-visible:border-0 focus-visible:ring-0"
              >
